...
private val initialChatMessages = listOf(
    ChatMessage(
        "me",
        mutableStateOf("Check it out!"),
        "8:07 PM"
    ),
    ChatMessage(
        "me",
        mutableStateOf("Thank you!$EMOJI_PINK_HEART"),
        "8:06 PM",
    ),
    ChatMessage(
        "Taylor Brooks",
        mutableStateOf("You can use all the same stuff"),
        "8:05 PM"
    ),
    ChatMessage(
        "Taylor Brooks",
        mutableStateOf("@aliconors Take a look at the `Flow.collectAsStateWithLifecycle()` APIs"),
        "8:05 PM"
    ),
    ChatMessage(
        "John Glenn",
        mutableStateOf("Compose newbie as well $EMOJI_FLAMINGO, have you looked at the JetNews sample? " +
    ...
    ChatMessage(
        "me",
        mutableStateOf("Compose newbie: I’ve scourged the internet for tutorials about async data " +
